// src/lib.rs
/*
 * Core library for ElasticsearchQuery
 */
...
#[derive(Debug)]
pub struct ElasticsearchQueryProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ElasticsearchQueryProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ElasticsearchQuery processing");
    
    let mut processor = ElasticsearchQueryProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ElasticsearchQueryProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ElasticsearchQueryProcessor::new(false);
